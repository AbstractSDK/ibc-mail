...
use abstract_sdk::{AccountVerification, AppInterface};
use abstract_sdk::features::AbstractRegistryAccess;
use abstract_std::app::{ExecuteMsg, QueryMsg};
use abstract_std::manager;
use abstract_std::manager::ModuleAddressesResponse;
use abstract_std::objects::AccountId;
use cosmwasm_schema::serde::de::DeserializeOwned;
use cosmwasm_std::{Addr, CosmosMsg, Deps, Empty, wasm_execute};
use cosmwasm_std::Uint128;
use crate::{Header, IBCMAIL_CLIENT_ID, Message, NewMessage, Route};

use crate::server::msg::ServerQueryMsg;

use crate::client::msg::{ClientExecuteMsg, ClientQueryMsg};
use crate::server::error::ServerError;

// API for Abstract SDK users
/// Interact with the hub adapter in your module.
pub trait ClientInterface:
Dependencies + ModuleIdentification + AbstractRegistryAccess
{
...
impl<'a, T: ClientInterface> MailClient<'a, T> {
    ...
    fn module_address(&self) -> AbstractSdkResult<Addr> {
        ...
        let module_addresses = self.deps.querier.query_wasm_smart::<ModuleAddressesResponse>(manager, &manager::QueryMsg::ModuleAddresses {
